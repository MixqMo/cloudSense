...
import { Wind, Sun, Cloud, Droplets } from "lucide-react";

// Datos mock para simular la API del clima
const mockWeatherData = {
  ...
  "london": {
    ...
    pressure: 1008,
    visibility: 6,
    airQuality: "unhealthy-sensitive" as const,
    windDirection: "SW",
    rainfall: 5.2
  },
  "default": {
...
const mockForecast = [
  { day: "Hoy", date: "Oct 4", condition: "sunny" as const, high: 25, low: 15, precipitation: 0 },
  { day: "Mañana", date: "Oct 5", condition: "cloudy" as const, high: 23, low: 14, precipitation: 20 },
  { day: "Lunes", date: "Oct 6", condition: "rainy" as const, high: 19, low: 12, precipitation: 80 },
  { day: "Martes", date: "Oct 7", condition: "cloudy" as const, high: 21, low: 13, precipitation: 30 },
  { day: "Miércoles", date: "Oct 8", condition: "sunny" as const, high: 24, low: 16, precipitation: 5 },
  { day: "Jueves", date: "Oct 9", condition: "sunny" as const, high: 26, low: 17, precipitation: 0 },
  { day: "Viernes", date: "Oct 10", condition: "cloudy" as const, high: 22, low: 15, precipitation: 15 }
];

export default function App() {
  const [currentWeather, setCurrentWeather] = useState(mockWeatherData.default);
  ...
  return (
    <div className="min-h-screen bg-gr adient-to-br from-sky-100 via-cyan-50 to-blue-100">
